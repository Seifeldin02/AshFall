...
public final class SMPCore extends JavaPlugin implements CommandExecutor,TabCompleter {
    ...
    @Override public void onEnable(){
        ...
        tradeTax=new TradeTaxService(this);nametags=new NametagService(this);spawners.startConsolidation();weeklyDragon=new WeeklyDragonService(this);graves=new GraveService(this);bulletin=new BulletinService(this);guides=new GuideService(this);messaging=new MessagingService(this);obsidian=new ObsidianDurabilityService(this,factions);
        ...
        for(Listener listener:List.of(nametags,enderChests,bank,settings,account,confirmations,shards,marketplace,graves,bulletin,guides,progress,netWorth,villagerDiscounts,nicknames,adminTools,ordersService,relics,spawnClaims,afk,bounties,ipBans))
