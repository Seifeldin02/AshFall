...
public final class SMPCore extends JavaPlugin implements CommandExecutor,TabCompleter {
    ...
    @Override public void onEnable(){
        ...
        adminTools=new AdminToolsService(this);discordReminders=new DiscordReminderService(this);ordersService=new OrdersService(this);afk=new AfkService(this);punishments=new PunishmentService(this);ipBans=new IpBanService(this);monuments=new MonumentService(this);
